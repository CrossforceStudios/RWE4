...
-- @source https://github.com/Sleitnick/RbxCameraShaker/tree/master/src/CameraShaker
-- @rostrap CameraShaker
-- @author Sleitnick
...
local CameraShakePresets = {
	...
	ReloadBump = function()
		local c = CameraShakeInstance.new(1, 4, 0.05, 0.25)
		c.PositionInfluence = Vector3.new(0.1, 0.1, 0.1)
		c.RotationInfluence = Vector3.new(.1, .1, .1)
		return c
	end;
	
	SelectFireBump = function()
		local c = CameraShakeInstance.new(1, 8, 0.05, 0.25)
		c.PositionInfluence = Vector3.new(0.1, 0.1, 0.1)
		c.RotationInfluence = Vector3.new(.1, .1, .1)
		return c
	end;
	...
	-- A bizarre shake with a very high magnitude and high roughness.
	-- Sustained.
	FastStumble = function()
		local c = CameraShakeInstance.new(10, 0.15, 1, 2)
		c.PositionInfluence = Vector3.new(0, 0, 0.15)
		c.RotationInfluence = Vector3.new(2, 1, 4)
		return c
	end;
