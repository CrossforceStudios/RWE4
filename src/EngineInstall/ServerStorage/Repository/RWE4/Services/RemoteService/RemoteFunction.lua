...
if game:GetService("RunService"):IsServer() == true then
	...
	function constructor.new(name, event)
		...
		if self == nil then
			...
			self.Server.Parent = game.ReplicatedStorage.Resources.RemoteEvents
			...
			self.Client.Parent = game.ReplicatedStorage.Resources.RemoteEvents
