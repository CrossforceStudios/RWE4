...
local Cartridges = {
	...
	Args = {
		...
		["Laser"] = {"Laser","Auto Blaster Laser",689,false,1408,BrickColor.new(Color3.fromRGB(88,218,171)),0,Vector3.new(0.1,0.1,5),196.2 * 0.15,0.15,NumberRange.new(32,50),0.25,0.55};
